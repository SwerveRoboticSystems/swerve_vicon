...
#define PULSE_IN_TIMEOUT     10000 // timeout for pulse function in microseconds
...
public:
  ...
  /** @fn int getChannelValue(int)
   *  @brief Returns the value of the specified channel (1-6)
   *  @author Frederick Wachter
   *  @date Created: 2018-03-08
   */
...
private:
  ...
  RCController6CHState _state;
  RCController6CHPins  _pins;
